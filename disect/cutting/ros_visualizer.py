...
class ROSVisualizer:
    ...
    def __init__(self,
        ...
        rospy.Service("/disect/simulation_step", Empty, self._step_simulation)
    ...
    def _step_simulation(self, req):
        ...
        for _ in range(substeps):
            ...
            self.hist_time.append(self.sim.sim_time)
        self.update_view()
        print("total computation time", timeit.default_timer() - start_time)
